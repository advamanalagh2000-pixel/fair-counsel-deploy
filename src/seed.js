...
async function seed() {
  ...
  if (lawyerCount === 0) {
    const verified = [
      { name: 'Adv. Meera Kulkarni', phone: '9800000001', init: 'MK', specs: ['Family Law', 'Personal Laws'], city: 'Jaipur', langs: ['Hindi', 'English'], experienceYears: 11, badge: 'fave', consultationsCompleted: 46, feePaise: 100000, bar: 'RAJ/1284/2013',
      ...
      { name: 'Adv. Vikram Rathi', phone: '9800000002', init: 'VR', specs: ['Family Law', 'Real Estate & Property Law'], city: 'Jaipur', langs: ['Hindi'], experienceYears: 7, badge: 'verified', consultationsCompleted: 22, feePaise: 80000, bar: 'RAJ/2041/2018',
      ...
      { name: 'Adv. Ayesha Khan', phone: '9800000003', init: 'AK', specs: ['Family Law', 'Civil Litigation'], city: 'Delhi', langs: ['English'], experienceYears: 15, badge: 'fave', consultationsCompleted: 61, feePaise: 120000, bar: 'DEL/0876/2009',
      ...
      { name: 'Adv. Rohan Deshpande', phone: '9800000004', init: 'RD', specs: ['Real Estate & Property Law', 'Infrastructure & Construction Law'], city: 'Pune', langs: ['Marathi', 'Hindi', 'English'], experienceYears: 9, badge: 'verified', consultationsCompleted: 34, feePaise: 70000, bar: 'MAH/1284/2016',
      ...
      { name: 'Adv. Sana Fatima', phone: '9800000005', init: 'SF', specs: ['Corporate & Commercial Law', 'Company Law', 'Intellectual Property Rights (IPR)'], city: 'Hyderabad', langs: ['English', 'Hindi'], experienceYears: 8, badge: 'verified', consultationsCompleted: 29, feePaise: 110000, bar: 'TS/0932/2017',
      ...
      { name: 'Adv. Karthik Iyer', phone: '9800000006', init: 'KI', specs: ['Criminal Law', 'Banking & Finance Law'], city: 'Bengaluru', langs: ['Kannada', 'English', 'Hindi'], experienceYears: 13, badge: 'fave', consultationsCompleted: 53, feePaise: 130000, bar: 'KAR/0451/2011',
